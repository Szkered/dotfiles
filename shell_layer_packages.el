...
(defun shell/init-vterm ()
  ...
  (use-package multi-libvterm
      :load-path "~/.emacs.d/private/local/multi-libvterm"
      ...
      :config
        ...
        :init
        (progn
          (make-shell-pop-command "multi-libvterm" multi-libvterm)
          (spacemacs/set-leader-keys "asl" 'spacemacs/shell-pop-multi-libvterm)
          (spacemacs/register-repl 'multi-libvterm 'multi-libvterm))
