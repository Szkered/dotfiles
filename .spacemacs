...
$ autoflake --in-place --remove-unused-variables --remove-all-unused-imports --remove-duplicate-keys --expand-star-imports <filename>"
  ...
  (spacemacs/set-leader-keys-for-major-mode 'python-mode "b" 'my-restart-python-console)
