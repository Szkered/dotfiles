...
(set-popup-rule! "*mu4e-main*" :size 0.95 :side 'bottom :slot 1 :ttl nil :select nil :modeline nil :quit nil)
(set-popup-rule! "*mu4e-headers*" :size 0.95 :side 'bottom :slot 1 :ttl nil :select nil :modeline nil :quit nil)
#+END_SRC
