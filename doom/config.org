...
(defconst my-main-pdfs-library-paths `("~/Dropbox/papers/inbox" "/Dropbox/papers/read/" "/Dropbox/papers/cited/"))
...
(setq elfeed-feeds-funcs
      '((arxiv-rss-feed-url "math.OC")
        (arxiv-rss-feed-url "stat.ML")
        (arxiv-rss-feed-url "cs.LG")
        ))
(setq elfeed-feeds (mapcar 'eval elfeed-feeds-funcs))
#+END_SRC
...
(use-package! org-roam-bibtex
  ...
  (setq org-roam-capture-templates
        '(("d" "default" plain "%?"
          ...
          ("s" "short bibliography reference (no id)" entry "* TODO [#D] ${title} [cite:@%^{citekey}]\n%?"
           :target (node "3b5d0d92-c6bb-4832-ae7a-cdc2e473ff58")
           :unnarrowed t
           :empty-lines-before 1
           :prepend t)))
