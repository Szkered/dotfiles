...
*** LSP exclude file from watcher
#+BEGIN_SRC emacs-lisp
(with-eval-after-load 'lsp-mode
  (add-to-list 'lsp-file-watch-ignored "[/\\\\]node_modules$")
  (add-to-list 'lsp-file-watch-ignored "[/\\\\].mypy_cache$")
  (add-to-list 'lsp-file-watch-ignored "[/\\\\].ob-jupyter$")
  (add-to-list 'lsp-file-watch-ignored "[/\\\\]_region_.prv$")
  (add-to-list 'lsp-file-watch-ignored "[/\\\\]build$")
  (add-to-list 'lsp-file-watch-ignored-directories "[/\\\\]bazel-.*\\'")
  (add-to-list 'lsp-file-watch-ignored "[/\\\\]bazel-.*\\'")
  )
#+END_SRC
...
(add-hook 'lsp-managed-mode-hook
          (lambda ()
            (when (derived-mode-p 'python-mode)
              (setq my/flycheck-local-cache '((lsp . ((next-checkers . (python-pylint python-flake8))))))
...
triple call to ensure TOC and reference are generated correctly
#+BEGIN_SRC emacs-lisp
