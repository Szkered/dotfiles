...
(doom! :input
       ...
       (dired
        +ranger
        +icon)                   ; making dired pretty [functional]
...
(defun my/tangle-conditionally (file)
  "Tangle current block only if its target file matches `my/tangle-file'."
  (if (string= (file-name-nondirectory file) my/tangle-file)
      file
    "no"))
