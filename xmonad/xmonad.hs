...
myAdditionalKeys =
  ...
  , ( "M-g"
    , sequence_ [cycleGapBorders, spawn "~/dotfiles/toggle_picom_style.sh"]
    )
  , ("M-f", spawn "pcmanfm")
  , ( "M-S-f"
    , spawn
...
myGaps :: [GapSpec]
myGaps =
  [[(L, 0), (R, 0), (U, 0), (D, 0)], [(L, 30), (R, 30), (U, 40), (D, 60)]]
...
myConfig =
  def { manageHook         = myManageHook <+> manageDocks <+> manageHook def
      -- layoutHook = myLayout,
